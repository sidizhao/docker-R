...
RUN R --vanilla -e 'install.packages(c("lmtest","mdscore", "ggplot2", "data.table", "sequenza", "dplyr", "reshape2", "tidyr", "viridis", "cowplot", "ggalluvial", "msigdbr", "ggdendro", "gridExtra", "deconstructSigs", "tidyverse", "splitstackshape"), repos = "http://cran.us.r-project.org")'
